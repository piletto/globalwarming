...
Простая модель, которая определяет 4 природных явления по фотографии и показывает их описание.
...
### Нейросеть определяет явление

### Через 3 секунды показывает описание

## ❓ Частые вопросы
## Какое фото лучше подходит?
### Чёткое, без размытия, с хорошим освещением.

## Что означают проценты?
### Это уверенность нейросети в своём ответе. Чем выше — тем лучше.




## что я использовала и где брала информацию?
