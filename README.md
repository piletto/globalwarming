...
Почему фото меняет размер?
Нейросеть принимает картинки только 224×224.

📝 Примечание
Код написан максимально просто, чтобы его понял даже начинающий программист. Описания явлений можно редактировать прямо в скрипте.
